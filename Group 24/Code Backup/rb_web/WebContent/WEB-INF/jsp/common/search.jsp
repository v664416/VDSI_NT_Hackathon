  ...
  <script src= "http://ajax.googleapis.com/ajax/libs/angularjs/1.3.14/angular.min.js"></script>
     <script type="text/javascript">
   		function getAutoRes(event){
   			if($("#autoref").prop("checked")){
   				var urlp = "search/query2?q="+$("#q").val();
...
<div class="container"  ng-app="myApp"  ng-controller="customersCtrl">
  ...
  <form role="form">
    <div class="form-group">
      <input type="text" autocomplete="off" class="form-control" list="qres" onkeyup="{getAutoRes(event)}" name="q" ng-model="serach" id="q" placeholder="Search Library">
    </div>
    <div class="checkbox">
	  <label><input type="checkbox" value="" ng-model="pageshow">PageResult</label>
	  <label><input type="checkbox" value="" id="autoref"> | Enable Auto Complete</label>
	</div>
